...
#'
#' @format A data frame with 13 observations (rows) and 5 variables (columns).
#' \tabular{llllr}{
#'   \tab \bold{Column name} \tab \bold{Data type} \tab \bold{Description} \tab \bold{Values}\cr
#'   \code{[,1]} \tab \code{Y} \tab numeric \tab The evolved heat in calories/gram \tab (72.5 - 115.9)\cr
#'   \code{[,2]} \tab \code{x1} \tab numeric \tab Percentage of 3CaO.Al2O3 \tab (1 - 21)\cr
#'   \code{[,3]} \tab \code{x2} \tab numeric \tab Percentage of 3CaO.SiO2 \tab (26 - 71)\cr
#'   \code{[,4]} \tab \code{x3} \tab numeric \tab Percentage of 4CaO.Al2O3.Fe2O3 \tab (4 - 23)\cr
#'   \code{[,5]} \tab \code{x4} \tab numeric \tab Percentage of 2CaO.SiO2 \tab (6 - 60)\cr
#' }
#'

#' riverfishing: Catches of salmon and seatrout in Norway in three periodes
#'
#' Catches from river-fishing in Norway, summarised for all rivers in four regions,
#' and from three distinct 5-year periodes.
#'
...
#'   \code{[,4]} \tab \code{Periode} \tab character \tab 5-year periodes \tab ("1993-97", "2005-09", "2018-22")\cr
#' }
#'
#' @examples
#'
#' # Linear model
#' res <- lm(Catchest ~ Region + Species + Periode, data = riverfishing)
#'

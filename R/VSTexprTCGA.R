...
#' 13946 genes from 1000 samples, 200 samples per tumour type.
#'
#' @format A data frame with 1000 observations (rows) and 13947 variables (columns).
#'
#' \tabular{llllr}{
#'   \tab \bold{Column name} \tab \bold{Data type} \tab \bold{Description} \tab \bold{Values}\cr
#'   \code{[,1]} \tab \code{classes} \tab factor \tab 5 different types of cancer \tab (Breast...Prostate)\cr
#'   \code{[,2:13947]} \tab \code{A1BG_1...TMED7-TICAM2_100302736} \tab numeric \tab Gene expression data \tab (8.109048 - 23.7329)
#' }
#'
#' @details
#'
...
#' Data subsetting was done by Torgeir Rhoden Hvidsten.
#'
#' @references
#'

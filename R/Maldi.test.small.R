#' Maldi.test.small: MALDI-TOF MS on Cow Milk
#'
...
#'
#' @format A data frame with 45 observations (rows) and 1031 variables
#' (columns).
#'
#' \tabular{llllr}{
...
#' \code{[,2:1031]} \tab \code{MSdata1...MSdata6175} \tab numeric \tab MS data for the milk samples \tab (-1.030459 - 6.669803)
#' }
#'
#' The variables with mass spectrometry data, \code{Maldi.test.small[, 2:1031]},
...
#'
#' This data set is a subset of the `Maldi.test` data (selected columns).
#'
#' @seealso `Maldi.train.small`, `Maldi.test` and `Maldi.train`
#'
#' @examples
#'
#' # Summary of some of the variables
#' summary(Maldi.test.small[, 1:6])
#'
#' # Plot one of the spectra
#' plot(Maldi.test.small[, 2], type = "l")
#'
#' # Plot several spectra
#' matplot(Maldi.test.small[, 2:6], type = "l", lty = 1)
#'
#' @references
#'
...
#' @docType data
#' @keywords datasets
#' @name Maldi.test.small
#' @usage Maldi.test.small
#'
"Maldi.test.small"

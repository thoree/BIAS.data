#' BeerDataNotClever: Beers Brewed by the Not-Clever Student
#'
...
#'   \code{[,1]} \tab \code{Taste} \tab numeric \tab The liking score for each beer \tab (0 - 8)\cr
...
#' @docType data
#' @keywords datasets
#' @name BeerDataNotClever
#' @usage BeerDataNotClever
#'
"BeerDataNotClever"
